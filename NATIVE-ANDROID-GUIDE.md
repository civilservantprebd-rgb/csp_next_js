...
- [ ] ডিপলিংক: `https://www.aarohon.com/exam/{id}` / custom scheme → অ্যাপে exam স্ক্রিন
      (⚠️ `www` বাদ দিলে Vercel 308 রিডাইরেক্ট করবে — মাপা ~৫৬৮ms বাড়তি ট্রিপ,
      আর ডিপলিংক হ্যান্ডলারে হোস্ট মেলানোর সময়ও ফারাক গড়ে তুলবে)
