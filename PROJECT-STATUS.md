# BCS One — প্রকল্পের অবস্থা ও হ্যান্ডওভার

> **নতুন সেশনে কী দিতে হবে:** এই ফাইলের পাথটা দিলেই হবে —
> `D:\App\bcs-one-flutter\PROJECT-STATUS.md`
> (সাথে `D:\App\bcs-one-nextjs`-ও উল্লেখ করবেন, কারণ কাজটা দুই প্রকল্পে ছড়ানো।)

**সর্বশেষ হালনাগাদ:** ২০২৬-০৯-১৬
...
|---|---|---|
| `D:\App\bcs-one-nextjs` | ওয়েব অ্যাপ (Next.js 14) **+ নতুন REST API লেয়ার** | অ্যাপের সব ডেটা এখান থেকেই আসে |
| `D:\App\bcs-one-flutter` | **Android অ্যাপ** (Flutter) | ব্যবহারকারী যেটা ফোনে চালান |
