    ...
    <section className="relative font-bengali rounded-3xl bg-white border border-slate-200 shadow-sm p-5 sm:p-7 transition-all duration-300">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pb-5 border-b border-rose-200">
        <div className="space-y-1">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-200/90 text-black border border-rose-300 text-xs font-black shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto justify-between sm:justify-end">
          ...
          <div className="shrink-0 bg-white px-3.5 py-1.5 rounded-xl border border-rose-300 text-xs font-black text-black flex items-center gap-1.5 shadow-sm">
      ...
      <div className="pt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {liveKeys.map((k) => {
          ...
          return (
            <div
              key={k}
              className="group bg-white rounded-2xl p-5 border border-rose-200/90 hover:border-rose-400 shadow-sm hover:shadow-sm transition-all duration-200 flex flex-col justify-between space-y-4"
            >
              ...
              <button
                ...
                className="w-full bg-rose-600 hover:bg-rose-700 text-white font-bold py-2.5 px-4 rounded-xl shadow-sm transition duration-150 flex items-center justify-center gap-2 text-xs sm:text-sm cursor-pointer active:scale-[0.98]"
              >
