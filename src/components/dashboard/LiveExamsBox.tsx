  ...
  return (
    <>
      ...
      <button
        ...
        className="w-full text-left font-bengali rounded-3xl bg-gradient-to-r from-rose-100 via-rose-50 to-white border border-rose-200 shadow-sm hover:shadow-md transition-all duration-200 group cursor-pointer p-4 sm:p-5 active:scale-[0.995]"
      >
        <div className="flex items-center gap-3.5">
          <div className="w-11 h-11 rounded-2xl bg-rose-600 text-white flex items-center justify-center shadow-md shadow-rose-600/30 shrink-0 group-hover:scale-105 transition">
          ...
          <span className="shrink-0 inline-flex items-center gap-1 rounded-xl bg-rose-600 text-white text-xs font-black px-3 py-2 group-hover:bg-rose-700 transition shadow-sm">
      ...
      {open && (
        ...
        >
          ...
          <div className="relative w-full sm:max-w-2xl max-h-[88vh] flex flex-col bg-white rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-6 duration-300">
            {/* হেডার */}
            <div className="bg-gradient-to-r from-rose-600 to-rose-700 text-white px-4 sm:px-6 py-4 flex items-center justify-between gap-3">
              ...
              {liveKeys.map((k) => {
                ...
                return (
                  <button
                    ...
                    type="button"
                    onClick={() => startExam(k)}
                    className="w-full text-left bg-white rounded-2xl border border-slate-200 hover:border-rose-400 hover:shadow-sm transition p-3.5 sm:p-4 cursor-pointer group"
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-1.5 flex-wrap mb-1">
                          ...
                          <span className="bg-rose-100 text-rose-900 text-[10px] font-black px-2 py-0.5 rounded-md border border-rose-300 flex items-center gap-1">
                        ...
                        <h4 className="font-black text-black text-sm sm:text-base group-hover:text-rose-800 transition leading-snug">
                          {ex.title}
                        </h4>
                        <div className="flex items-center gap-3 mt-1.5 text-[11px] text-slate-600 font-bold flex-wrap">
                          ...
                          <span className="flex items-center gap-1">
                            <Clock className="w-3.5 h-3.5 text-rose-600" /> {toBengaliDigits(ex.timerMinutes)} মিনিট
                          </span>
                          <span className="flex items-center gap-1">
                      ...
                      <span className="shrink-0 w-9 h-9 rounded-xl bg-rose-600 group-hover:bg-rose-700 text-white flex items-center justify-center transition shadow-sm">
